    ...
    return (
        <div className="my-28">
            <div className="flex items-center justify-between">
                <h2 className="font-bold text-2xl">پربازدیدترین تخصص‌ها</h2>
                <Link className="text-gray-500 hover:text-violet-800 text-sm  transition-all" href={'/'}>مشاهده همه تخصص‌ها</Link>
            </div>
